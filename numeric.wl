...
StringMatchQ[errorbarQStr,{"notbar" ,"L_"~~NumberString~~"_ci_"~~NumberString}] (*eg."L_0.90_ci_1.50"*)
],
...
(*  decuplet baryons *)
{
mass\[CapitalDelta]->1.232`20,
mass\[CapitalSigma]s->1.385`20,
mass\[CapitalXi]s->1.530`20,
mass\[CapitalOmega]->1.672`20
};
