...
chTagKey[fyTag]->chTag[chOct,x@fdType["octb"],x@fyVtx[fdType["mes"],"v2"]],
...
chOct=x@fdType["oct"];
chTagKey["in"]->chTag[chOct],
chTagKey[fyTag]->chTag[x@fdType["oct"],x@fdType["octb"],x@fyVtx[fdType["mes"],"v2"]],
fyCoeKey["cStr"]->x@fyCoeKey["cStr"],
