...
(*wlToNB[wl_]:=Module[{wlObj=NotebookOpen[wl]},*)
...
(*nbToWL[nb_]:=Module[{nbObj=NotebookOpen[nb]},*)
...
(* ::Input:: *)
(*(*\:5c06\:6839\:76ee\:5f55\:4e0b\:7684\:6240\:6709wl\:8f6c\:6362\:6210nb*)*)
(*wlToNB/@FileNames["*.wl",gitLocalName]*)
