...
ffsMerged[treeSum_,loopAmpSum_]:=Merge[{treeSum,loopAmpSum},<|
...
ffsMerged["v"][[Key@$ord0,Key@fd,Key@ffsTreeF1F2,1]]-
ffsMerged["v"][[Key@$ord0,Key@fd,Key@ffsLoopF1F2,1]]/.quarkQ];
...
ffsMerged["WithRen"]=Query[All,All,
...
numFFs["fit",ffsMergedWithRen_,chopQ2Val_]:=If[!$fittingQ,
(*\:666e\:901a\:6570\:503c\:8ba1\:7b97\:4f7f\:7528\:7684\:8868\:8fbe\:5f0f*)
Query[All,<|
...
(*\:6839\:636e\:7ea7\:6570 level,\:9009\:62e9 chop \:7684\:5177\:4f53\:5f62\:5f0f, numVal \:662f\:9884\:7559\:63a5\:53e3,\:63a7\:5236\:6570\:5b57\:683c\:5f0f\:5316*)
numFFs["ord",ffsMergedWithRen_,$parOrdStr_]:=Module[{chopQ2Val},
If[$parOrdStr===$ord0,
chopQ2Val[x_]:=numVal@chopQ2[x],
chopQ2Val[x_]:=numVal@chop[x]];
numFFs["fit",ffsMergedWithRen,chopQ2Val]];


numFFs["v"]=<|
$ord0->numFFs["ord",ffsMerged["WithRen"][[$ord0]],$ord0],
$parOrdStr->numFFs["ord",ffsMerged["WithRen"][[$parOrdStr]],$parOrdStr]
|>;
